...
import { updateListing, type CreateListingState } from "@/app/(app)/marketplace/actions";
import { ListingFormFields, type GameOption, type ListingFormDefaults } from "./listing-form-fields";
    ...
    <div className="fixed inset-0 z-60 overflow-y-auto p-4">
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="font-display text-base font-bold text-foreground">Edit listing</h2>
          <button
            type="button"
            onClick={onClose}
            aria-label="Close"
        ...
        <div className="mt-4">
          <ListingFormFields games={games} defaults={defaults} currentImageUrl={currentImageUrl} />
        </div>
