...
import { createListing, type CreateListingState } from "@/app/(app)/marketplace/actions";
import { ListingFormFields, type GameOption } from "./listing-form-fields";
...
export function AddListingModal({ games }: { games: GameOption[] }) {
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto p-4">
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="font-display text-base font-bold text-foreground">Add listing</h2>
              <button
                type="button"
