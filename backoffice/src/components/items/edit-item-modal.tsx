...
import { updateItem, type CreateItemState } from "@/app/(app)/items/actions";
import { ItemFormFields, type ItemFormDefaults } from "./item-form-fields";
...
export function EditItemModal({
  ...
  const boundAction = updateItem.bind(null, itemId);
    ...
    <div className="fixed inset-0 z-60 overflow-y-auto p-4">
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="font-display text-base font-bold text-foreground">Edit item</h2>
          <button
            type="button"
            onClick={onClose}
            aria-label="Close"
        ...
        <div className="mt-4">
          <ItemFormFields defaults={defaults} currentImageUrl={currentImageUrl} />
        </div>
