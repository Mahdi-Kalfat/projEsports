...
import { updateEvent, type CreateEventState } from "@/app/(app)/events/actions";
import { EventFormFields, type EventFormDefaults, type GameOption } from "./event-form-fields";
    ...
    <div className="fixed inset-0 z-60 overflow-y-auto p-4">
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="font-display text-base font-bold text-foreground">Edit event</h2>
          <button
            type="button"
            onClick={onClose}
            aria-label="Close"
