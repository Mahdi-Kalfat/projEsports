...
import { createEvent, type CreateEventState } from "@/app/(app)/events/actions";
import { EventFormFields, type GameOption } from "./event-form-fields";
...
export function AddEventModal({ games }: { games: GameOption[] }) {
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto p-4">
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="font-display text-base font-bold text-foreground">Add event</h2>
              <button
                type="button"
